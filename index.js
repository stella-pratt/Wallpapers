let wallpaper_info = [
    ...
    "mountains reflection sunrise hills tussock snow hills lake water sky clouds",
    "neon purple pink sunset sun skyline city buildings towers silhouette",
    "neon purple pink sunset sun skyline city buildings towers silhouette rays",
    "smoke air turbulent swirls blue black green haze",
    "smoke blue purple swirls black air spiral pattern",
    "smoke air red blue contrast black plume swirl rise",
    "smoke brown purple blue black contrast plume swirl rise",
    "topography map black pattern white lines loops",
    "topography map pattern black white lines loops thick",
    "topography map pattern lines loops thick green ",
    "topography map pattern lines loops thick green red squiggles",
    "topography map green black pattern white lines loops",
    "trees green waterfall river leaves trunk rocks cascade",
    "trees green waterfall river leaves trunk rocks cascade",
    "drinks neon sign pink purple led retro bar,",
    "greenhouse green plants white sun rays growing",
    "tomato plants green red pink sun rays greenhouse vines",
    "stump tree blue mushrooms glowing mystical trunk forest",
    "stump tree blue mushrooms glowing mystical trunk forest leaves scary horror",
    "stump tree blue mushrooms glowing mystical trunk forest vines",
    "stump tree blue mushrooms glowing mystical trunk forest vines rocks moss",
    "plain simple grey hills sun minimalistic",
    "pastel hills grey simple minimalistic",
    "retro pertol station gas fuel garage sunset orange purple pump clouds gradient road",
    "retro pertol station gas fuel garage sunset orange purple pump clouds gradient road",
    "retro pertol station gas fuel garage sunset orange purple pump clouds gradient road power pole",
    "retro pertol station gas fuel garage sunset orange purple pump clouds gradient road car sun",
    "purple magical futuristic knight sword blue armour metal head face glowing",
    "purple magical futuristic knight white armour metal head face gradient scary",
    "scary knight wizard purple black glow eyes hood sparkle head face futuristic mystical",
    "shperes shiny reflective balls yellow pink blue silver circles",
    "silver balls marbles bearings shiny floor white floating",
    "paint splatter marble white color colour spots shiny",
    "marbles orange background shadow shiny reflective",
    "city retro sunset skyline buildings skyscrapers gradient clouds sun",
    "city retro sunset skyline buildings skyscrapers gradient clouds sun towers",
    "mountains lake water ocean sea hills mountains sun clouds sky reflection",
    "mountains lake water ocean sea hills mountains sun clouds sky reflection sunset",
    "mountains lake water ocean sea hills mountains sun clouds sky reflection sunset orange",
    "sea ocean water waves night moon reflection clouds black white"
]
let wallpaper_dict = {
...
slide_papers.forEach((slide_paper) =>{
    carousel_src = (Math.floor(Math.random() * 162))+1
    slide_paper.src = "images/Final%20images/FHD/" + carousel_src + ".jpg"
    slide_paper.alt = wallpaper_info[carousel_src - 1]
})
...
homepage_category.forEach((category_parent) =>{
    ...
    image_wrapper.forEach((wrapper) =>{
        ...
        real_image.alt = wallpaper_info[insert_image - 1]
    })
})
